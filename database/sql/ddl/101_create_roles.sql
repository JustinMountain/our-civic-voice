...
GRANT SELECT ON TABLE ontario_mpps TO rest;
GRANT SELECT ON TABLE ontario_mpp_offices TO rest;
...
GRANT SELECT ON TABLE federal_mps TO rest;
GRANT SELECT ON TABLE federal_mp_offices TO rest;
...
GRANT SELECT ON all_representatives TO rest;
